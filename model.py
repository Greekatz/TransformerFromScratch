...
class MultiHeadAttentionBlock(nn.Module):
    ...
    def attention(query, key, value, mask, dropout: nn.Dropout):
        ...
        # (Batch, Seq_len, d_model) --> (Batch, h, Seq_len
...
class ResidualConnection(nn.Module):
    ...
    def __init__(self, dropou: float) -> None:
        super().__init__()
        self.dropout = nn.Dropout(dropout)
...
class DecoderBlock(nn.Module):
    ...
    def __init__(self, self_attention_block: MultiHeadAttentionBlock, cross_attetion_block: MultiHeadAttentionBlock, feed_forward_block: FeedForwardBlock) -> None:
        super().__init__()
        self.self_attention_block = self_attention_block
